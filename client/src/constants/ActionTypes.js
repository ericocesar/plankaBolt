...
export default {
  ...
  OPEN_PASSWORD_RESET_MODAL: 'OPEN_PASSWORD_RESET_MODAL',
  CLOSE_PASSWORD_RESET_MODAL: 'CLOSE_PASSWORD_RESET_MODAL',
  PASSWORD_RESET_REQUEST: 'PASSWORD_RESET_REQUEST',
  PASSWORD_RESET_REQUEST__SUCCESS: 'PASSWORD_RESET_REQUEST__SUCCESS',
  PASSWORD_RESET_REQUEST__FAILURE: 'PASSWORD_RESET_REQUEST__FAILURE',
  PASSWORD_RESET_REQUEST_ERROR_CLEAR: 'PASSWORD_RESET_REQUEST_ERROR_CLEAR',
  PASSWORD_RESET: 'PASSWORD_RESET',
  PASSWORD_RESET__SUCCESS: 'PASSWORD_RESET__SUCCESS',
  PASSWORD_RESET__FAILURE: 'PASSWORD_RESET__FAILURE',
  PASSWORD_RESET_ERROR_CLEAR: 'PASSWORD_RESET_ERROR_CLEAR',
