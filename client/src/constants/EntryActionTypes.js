...
export default {
  ...
  PASSWORD_RESET_REQUEST: `${PREFIX}/PASSWORD_RESET_REQUEST`,
  PASSWORD_RESET_REQUEST_ERROR_CLEAR: `${PREFIX}/PASSWORD_RESET_REQUEST_ERROR_CLEAR`,
  PASSWORD_RESET: `${PREFIX}/PASSWORD_RESET`,
  PASSWORD_RESET_ERROR_CLEAR: `${PREFIX}/PASSWORD_RESET_ERROR_CLEAR`,
  ...
  COVER_IMAGE_IN_CURRENT_PROJECT_CREATE: `${PREFIX}/COVER_IMAGE_IN_CURRENT_PROJECT_CREATE`,
