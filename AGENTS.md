...
- `charts/` — explain what lives here and when agents should edit it.
...
- `CONTRIBUTOR_LICENSE_AGREEMENT.md/` — explain what lives here and when agents should edit it.
- `debug-localhost-white-screen.md/` — explain what lives here and when agents should edit it.
- `docker-backup.sh/` — explain what lives here and when agents should edit it.
